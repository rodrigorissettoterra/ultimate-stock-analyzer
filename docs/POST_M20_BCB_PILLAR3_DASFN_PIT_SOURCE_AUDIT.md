...
The smoke workflow queries the DASFN catalog for `Api eq 'pilar3'` separately for
version families 1 and 2 and records:

- SHA-256 and byte size of each live OData response;
- row count;
- catalog field names;
