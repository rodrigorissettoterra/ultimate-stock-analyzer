...
def test_b3_get_detail_parser_restores_leading_zero_in_cnpj() -> None:
    detail = B3ListedCompanyDetailCollector().parse(
        {
            "codeCVM": "27693",
            "cnpj": "4.601.397/0001-28",
            "issuingCompany": "BRST",
            "code": "BRST3",
            "dateQuotation": "05/12/2024",
            "otherCodes": [{"code": "BRST3", "isin": "BRBRSTACNOR8"}],
        },
        expected_cvm_code=27693,
        collected_at=datetime(2026, 8, 31, tzinfo=UTC),
    )

    assert detail.cnpj == "04601397000128"
