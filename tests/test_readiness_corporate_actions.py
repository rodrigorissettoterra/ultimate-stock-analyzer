...
def _evidence(
    *,
    ...
    return CorporateActionReadinessEvidence(
        ...
        integration_report_sha256="b" * 64,
    )
...
def test_strict_scope_matched_event_evidence_can_resolve_raw_price_blocker() -> None:
    report = integrate_corporate_action_readiness(
        _base_report(),
...
def test_parser_marks_live_style_diagnostic_m15_path_as_validated() -> None:
    ...
    assert evidence.integration_report_sha256 == "c" * 64
