...
@pytest.mark.parametrize("missing_field", ["Api", "Versao", "Recurso", "Url"])
def test_missing_required_catalog_field_blocks_entire_contract(missing_field: str) -> None:
    ...
    payload["value"].append(
        {
            ...
            "Url": "https://example.invalid/pillar3/v10",
        }
    )
    audit = _audit(query_content=json.dumps(payload).encode())
