...
import ultimate_stock_analyzer.backtesting.bank_field_evidence_routing as bank_routing
import ultimate_stock_analyzer.backtesting.cvm_bank_net_income_canonical_mapping_audit as cvm_mapping
import ultimate_stock_analyzer.backtesting.cvm_ipe_pillar3_numeric_values as pillar3_values
import ultimate_stock_analyzer.domain.master as master
...
CVM_SCOPE_BLOCKER = cvm_mapping.CVM_BANK_DFP_PRUDENTIAL_SCOPE_ALIGNMENT_UNPROVEN
CVM_REVISION_BLOCKER = cvm_mapping.CVM_BANK_DFP_REVISION_HISTORY_COMPLETENESS_UNPROVEN
PILLAR3_REVISION_BLOCKER = pillar3_values.PILLAR3_IPE_REVISION_HISTORY_COMPLETENESS_UNPROVEN
...
def _pillar3() -> pillar3_values.Pillar3PrudentialObservation:
    return pillar3_values.Pillar3PrudentialObservation(
...
def test_ifdata_values_are_visible_but_not_strict_pit() -> None:
    report = bank_routing.route_bank_field_evidence(
        _profile(),
...
def test_as_of_excludes_future_cvm_filing() -> None:
    ...
    assert bank_routing.BANK_FIELD_EVIDENCE_MISSING in annual.blockers
...
def test_as_of_excludes_future_ifdata_estimate() -> None:
    ...
    assert bank_routing.BANK_FIELD_NOT_YET_AVAILABLE_AS_OF in assets.blockers
