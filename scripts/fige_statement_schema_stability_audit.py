...
def main() -> None:
    ...
    payload = {
        ...
        "notes": [
            "Diagnostic only: candidate codes come from the validated FIGE 2025 official statement tree.",
            "Each annual archive is filtered to exact CD_CVM=6041 before filing-metadata attachment, so unrelated issuers cannot contaminate this issuer-bounded audit.",
            "The audit compares exact statement + account_code pairs and never infers equivalence from names.",
            ...
            "Latest-state CVM annual archives are not complete revision-history point-in-time evidence for strict historical backtests.",
        ],
    }
