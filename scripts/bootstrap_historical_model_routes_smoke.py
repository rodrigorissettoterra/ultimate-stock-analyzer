...
MAPPING_PATH = Path("config/backtesting/fca_model_routes_v0.2.yml")
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="usa-fca-route-bootstrap-") as temp_dir:
        ...
        evidence = {
            ...
            "trusted_mapping_sha256": hashlib.sha256(MAPPING_PATH.read_bytes()).hexdigest(),
            "trusted_sector_registry_sha256": hashlib.sha256(
            ...
            "custom_route_source_injection_allowed": False,
            "effect": "manifest_bound_fca_reused_with_trusted_route_configuration",
        }
