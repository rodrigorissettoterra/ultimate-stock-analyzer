...
def attach_document_metadata(
    ...
    *,
    ...
    contract validation can set ``strict_natural_key=True`` to reject fallback
    ambiguity entirely. Direct ``ID_DOC`` ambiguity always remains strict because
    an exact document identifier must be unique.
    """
