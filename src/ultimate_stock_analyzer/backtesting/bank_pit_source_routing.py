...
def _critical_routes() -> tuple[BankInputSourceRoute, ...]:
    ...
    candidate = "timestamped_candidate_unaligned"
    return (
        BankInputSourceRoute("total_assets", cvm, candidate, "total_assets", BANK_SCOPE_ALIGNMENT_UNPROVEN),
        BankInputSourceRoute("prior_total_assets", cvm, candidate, "total_assets", BANK_SCOPE_ALIGNMENT_UNPROVEN),
        BankInputSourceRoute("equity", cvm, candidate, "equity", BANK_SCOPE_ALIGNMENT_UNPROVEN),
        BankInputSourceRoute("prior_equity", cvm, candidate, "equity", BANK_SCOPE_ALIGNMENT_UNPROVEN),
...
def _model_metric_routes() -> tuple[BankModelMetricRoute, ...]:
    ...
    return (
        BankModelMetricRoute("roe", "profitability", 0.1125, cvm, "timestamped_candidate_unaligned", ("annual_net_income", "equity", "prior_equity")),
        BankModelMetricRoute("roa", "profitability", 0.0625, cvm, "timestamped_candidate_unaligned", ("annual_net_income", "total_assets", "prior_total_assets")),
        BankModelMetricRoute("net_interest_margin", "profitability", 0.075, unresolved, "unresolved"),
        BankModelMetricRoute("npl_90d_ratio", "asset_quality", 0.10, unresolved, "unresolved"),
        BankModelMetricRoute("cost_of_credit", "asset_quality", 0.075, ifdata, "latest_state_non_pit", ("annual_credit_loss_result", "gross_credit_portfolio", "prior_gross_credit_portfolio")),
        BankModelMetricRoute("npl_coverage", "asset_quality", 0.075, unresolved, "unresolved"),
        BankModelMetricRoute("basel_ratio", "capital", 0.09, pillar3, "validated_observed_pit", ("basel_ratio",)),
        BankModelMetricRoute("tier1_ratio", "capital", 0.07, pillar3, "validated_observed_pit", ("tier1_ratio",)),
        BankModelMetricRoute("equity_to_assets", "capital", 0.04, cvm, "timestamped_candidate_unaligned", ("equity", "total_assets")),
        BankModelMetricRoute("efficiency_ratio", "efficiency", 0.105, ifdata, "latest_state_non_pit"),
        BankModelMetricRoute("fee_income_share", "efficiency", 0.045, ifdata, "latest_state_non_pit"),
        BankModelMetricRoute("loan_cagr_5y", "growth", 0.02, ifdata, "latest_state_non_pit", ("gross_credit_portfolio",)),
        BankModelMetricRoute("net_income_cagr_5y", "growth", 0.03, cvm, "timestamped_candidate_unaligned", ("annual_net_income",)),
        BankModelMetricRoute("dividend_regularity", "dividends", 0.045, dividends, "outside_bank_accounting_pit_audit"),
        BankModelMetricRoute("dividend_sustainability", "dividends", 0.04, dividends, "outside_bank_accounting_pit_audit"),
        BankModelMetricRoute("dividend_cagr_5y", "dividends", 0.015, dividends, "outside_bank_accounting_pit_audit"),
    )
